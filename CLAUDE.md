...
| Boundary | Why frozen |
|---|---|
| **V11 statistical gate** (`MIN_TRADES_FOR_SIG`, PF 95% CI, PSR/DSR thresholds — DSR ≥ 0.90 (operator methodology decision 2026-06-15; was 0.95), walk-forward stability cutoffs) + **V60 economic gate** (`ANNUALIZED_RETURN_PASS_THRESHOLD_PCT=0.0` since 2026-06-19; was 10.0 — operator removed the absolute-return floor platform-wide) | Methodology contract. Loosening to fit a candidate is fraud. The 2026-06-15 DSR drop to 0.90 AND the 2026-06-19 removal of the 10%/yr economic floor (10.0→0.0) were both explicit, deliberate operator methodology decisions applied platform-wide — not fits to any pending candidate; V11 statistical rigor (DSR≥0.90, PSR, walk-forward) + the V102 live-deploy 10% CAGR gate remain the quality bars. +20bps slippage check was retired — slippage_haircut_pnl is still logged for audit but no longer gates the verdict. |
